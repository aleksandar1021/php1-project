    ...
    if(isset($_POST['porudzbina'])){
        ...
        $korpa = json_decode($kor, true);
         ...
         foreach ($korpa as $k){
            ...
            $upit = "INSERT INTO kupovina(id_proizvod, id_korisnik, kolicina, cena_komad, ukupna_cena) VALUES (" . intval($idd) . ", " . intval($id) . ", " . intval($qt) . ", " . sprintf('%.2f', $trenutna->cena) . ", " . sprintf('%.2f', $trenutna->cena*$qt) . ")";
