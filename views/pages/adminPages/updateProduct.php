<?php 
    ...
    $id = $_GET["id"];
        $upitProizvod ="SELECT p.id_promocija, c.cena, p.id_kategorija, p.id_proizvod, p.id_brend, opis, naziv, slika, naziv_brend, boja, naziv_kategorija 
                        FROM proizvod p 
                            ...
                            var_dump($proizvod);
                                ...
                                foreach($brendovi as $b){
                                    if($b->id_brend == $proizvod->id_brend){
                                        echo "<option selected value='$b->id_brend'>$proizvod->naziv_brend</option>";
                                    }else{
