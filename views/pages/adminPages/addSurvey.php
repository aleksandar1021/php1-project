<div class="container-fluid p-0">
    <h2 class="mb-4">Insert new survey</h2>
    <form method="post" action="models/addSurvey.php" enctype="multipart/form-data">
        <div class="form-group mb-3">
            <label for="exampleFormControlInput1">Question:</label>
            <input type="text" class="form-control mb-4" id="pitanje" name="pitanje" placeholder="Enter question">
        ...
        <button type="submit" name="potvrdi" class="btn btn-danger">Insert survey</button>
    </form>
</div>
