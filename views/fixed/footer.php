    ...
    <div class="footer_agileinfo_topf py-5">
        <div class="container py-md-5">
            <div class="row" id="fot">
                <div class="col-lg-3 footer_wthree_gridf">
                    <h2><a href="index.php?page=home"><span>B</span>aggage
                        </a> </h2>
                    <label class="sub-des2">Online Store</label>
                </div>
                <div class="col-lg-5 f-flex align-items-center col-sm-12 footer_wthree_gridf mt-md-0 mt-4" >
    ...
    <!-- copyright -->
    <div class="cpy-right text-center py-3 foot">
        <div><a id="doc" target="_blank" href="dokumentacija.docx">Documentation</a></div>
